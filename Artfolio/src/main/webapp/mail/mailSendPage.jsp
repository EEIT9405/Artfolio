			...
			<div class="">				
					...
					<div class="form-group" style="width: 850px;">
						<form action="mail.controller" method="post"
							...
							<label for="email">收件者:</label> <input type="text"
								class="form-control" id="recipientmail" name="recipientmail"
								size="40" value="${toEmail}" /> <label for="email">寄件者:</label>
							<input type="text" class="form-control" id="Sender" name="Sender"
								size="40" value="${fromName} (${fromEmail})" disabled="disabled" />
							<label for="email">主旨:</label> <input type="text"
								class="form-control" name="title" size="40" value="${title}" />
							<br>
							<textarea class="form-control" rows="10" name="content"></textarea>
							<input type="hidden" name="mState" value="${mState}" /> <input
								type="hidden" name="recipient" value="${toId}" /> <br>
